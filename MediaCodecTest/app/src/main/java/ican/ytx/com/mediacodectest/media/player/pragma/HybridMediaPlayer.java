...
public class HybridMediaPlayer extends AbstractMediaPlayer {


    public static final String TAG = "HybridMediaPlayer";
    ...
    public HybridMediaPlayer(){
        this(sLocalLibLoader);
    }

    public HybridMediaPlayer(LibLoader libLoader){
    ...
    private void initPlayer(LibLoader libLoader){
         ...
         */
        native_setup(new WeakReference<HybridMediaPlayer>(this));
    }
    ...
    public static void loadLibrariesOnce(LibLoader libLoader) {
        synchronized (HybridMediaPlayer.class) {
            if (!mIsLibLoaded) {
                if (libLoader == null)
    ...
    @Override
    public void setGlSurfaceView(VideoGlSurfaceView glSurfaceView) {
        this.glSurfaceView = glSurfaceView;
        _setGlSurfaceView(this.glSurfaceView);
    ...
    private static class EventHandler extends Handler {
        ...
        public EventHandler(HybridMediaPlayer mp, Looper looper) {
            super(looper);
            mWeakPlayer = new WeakReference<HybridMediaPlayer>(mp);
        }

        @Override
        public void handleMessage(Message msg) {
            YtxLog.d(TAG,"handleMessage");
            HybridMediaPlayer player = mWeakPlayer.get();
    ...
    public static void postEventFromNative(Object weakThiz, int what,
        ...
        HybridMediaPlayer mp = (HybridMediaPlayer) ((WeakReference) weakThiz).get();
        if (mp == null) {
            return;
        }
...
//        }
    ...
    private native void _setGlSurfaceView(Object glSurfaceView);
